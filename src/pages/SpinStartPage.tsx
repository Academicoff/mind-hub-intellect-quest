...
export default function SpinStartPage() {
  const navigate = useNavigate();

  const onStart = () => navigate('/spinquiz');
      ...
      <div className="max-w-3xl w-full text-center space-y-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-lg mx-auto">
            Ответь на&nbsp;18&nbsp;коротких вопроса и&nbsp;узнай, что подойдёт именно тебе —
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="iq-card text-center">
            ...
            <p className="text-sm text-muted-foreground">18 вопроса — и всё понятно</p>
          </div>
          <div className="iq-card text-center">
