...
export const questions: Question[] = [
  ...
  /* 4  */ { id: 4,  type: "text", question: "Маше — 16 лет. Она в четыре раза старше брата. Сколько лет будет Маше, когда она станет вдвое старше брата?", options: ["20", "24", "28", "32"], correctAnswer: 1 },
  ...
  /* 8  */ { id: 8,  type: "text", question: "Какое число лишнее: 14, 21, 28, 32, 35, 42?", options: ["21", "28", "32", "35"], correctAnswer: 2 },
  /* 9  */ { id: 9,  type: "text", question: "[NL Hold'em] Когда в вашем диапазоне оказалось больше очень сильных рук, чем в диапазоне оппонента (то есть у вас есть “преимущество по натсам”), вы, как правило, должны…", options: ["Делать ставки чаще", "Ставить ставки большего размера", "Всё вышеперечисленное"], correctAnswer: 2 },
  ...
  /* 13 */ { id:13,  type: "text", question: "Какое число делится на 3: 7 364 / 7 372 / 7 381 / 7 392?", options: ["7 364", "7 372", "7 381", "7 392"], correctAnswer: 3 },
  ...
  /* 19 */ { id:19,  type: "text", question: "[PLO] Предположим, вы защитили большой блайнд против рейза с баттона и затем сыграли чек-колл ставку на непарном “среднем” флопе J-7-5. По каким картам тёрна вам чаще всего следует лидить(донк-бетить) в префлоп-агрессора?", options: ["Когда спарится старшая карта (J)", "Когда спарится средняя или младшая карта борда (7 или 5)", "Когда тёрн закрывает множество стрейт-дро (8, 9 или 10)", "Когда тёрном выходит туз (A)"], correctAnswer: 1 },
  /* 20 */ { id:20,  type: "text", question: "[Теория покера] Как прежде всего следует скорректировать свою стратегию открытия префлоп-рейзом, если сразу слева от вас сидит игрок, который очень агрессивно делает 3-беты?", options: ["Чаще открываться ставкой", "Реже открываться ставкой"], correctAnswer: 1 },
  ...
  /* 33 */ { id:33,  type: "text", question: "Какова вероятность выбросить хотя бы одну шестёрку двумя кубиками?", options: ["~25-26%", "~30-31%", "~35-36%", "~39-40%"], correctAnswer: 1 },
  ...
  /* 41 */ { id:41,  type: "text", question: "[NL Hold'em] Верно или неверно: в кэш-играх вы должны чаще холодно каллировать рейзы в позиции, чем в турнирах", options: ["Верно", "Неверно"], correctAnswer: 0 },
  ...
  /* 44 */ { id:44,  type: "text", question: "[Теория покера] По мере того как размеры стэков увеличиваются (например, со 100 BB до 200 BB), вам следует играть _____ стратегию префлоп.", options: ["более свободную (широкую)", "более тайтовую (узкую)"], correctAnswer: 0 },
  ...
  /* 47 */ { id:47,  type: "text", question: "100 выключателей сначала выключены. Игроки 1…100 по очереди меняют состояние кратных своих номеров. Сколько горит в конце?", options: ["10", "15", "20", "25"], correctAnswer: 0 },
